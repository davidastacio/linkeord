...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground shadow-soft hover:bg-[#004CE0]",
        secondary: "bg-secondary text-secondary-foreground hover:bg-[#dcecff]",
        outline: "border border-border bg-white text-navy shadow-sm hover:bg-secondary",
        ghost: "text-navy hover:bg-secondary",
        navy: "bg-navy text-white hover:bg-[#102a59]"
      },
      size: {
        default: "h-11 px-5",
        sm: "h-9 px-3",
